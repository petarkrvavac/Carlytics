    ...
    <Card className="relative overflow-hidden p-4">
      ...
      <div className="relative">
        ...
        <div className="grid gap-4 lg:grid-cols-[auto_1fr] lg:items-center">
          <Link
            href="/flota"
            className="grid h-24 w-24 place-items-center justify-self-center rounded-full lg:justify-self-start"
            style={{
          ...
          <div className="grid grid-cols-2 gap-2.5 text-sm">
            <Link
              href="/flota"
              className="rounded-xl border border-border bg-surface p-2.5 transition hover:border-cyan-500/45"
            >
              <p className="text-muted">Slobodna + zauzeta</p>
              <p className="mt-1.5 text-base font-semibold text-foreground">{summary.operational}</p>
            </Link>
            <Link
              href="/flota?status=servis"
              className="rounded-xl border border-border bg-surface p-2.5 transition hover:border-amber-500/45"
            >
              <p className="text-muted">Na servisu</p>
              <p className="mt-1.5 text-base font-semibold text-amber-300">{summary.inService}</p>
            </Link>
            <Link
              href="/flota"
              className="rounded-xl border border-border bg-surface p-2.5 transition hover:border-slate-600"
            >
              <p className="text-muted">Ukupno vozila</p>
              <p className="mt-1.5 flex items-center gap-1.5 text-base font-semibold text-foreground">
            ...
            <Link
              ...
              className="rounded-xl border border-border bg-surface p-2.5 transition hover:border-sky-500/45"
            >
              <p className="text-muted">Aktivna zauzeća</p>
              <p className="mt-1.5 flex items-center gap-1.5 text-base font-semibold text-sky-300">
